$(document).ready(function () {
        ...
        executeService(jsonData, function (response_from_service) {
          //console.log(response_from_service);
            ...
            arrInfo.forEach(info => {
                info.label = capitalizeEachWord(info.employee_name);
            });
    ...
    //     $('#subDepartment').val(''); // Empty lower-level fields
    //     $('#sub_id').val(''); // Empty corresponding IDs
    //     document.getElementById('subDepartment').classList.remove('is-valid', 'is-invalid');
    // });
