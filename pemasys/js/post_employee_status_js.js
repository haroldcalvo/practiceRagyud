$(document).ready(function(){
    $('#btnSave').click(function(){   
        ...
        if (status_id == 0 || employee_id == 0){
            ...
            $('#save-message').remove();
            $('#message-form').prepend('<span id="save-message" class="control-label mb-1"><small class="is-valid">Are you sure you want to save this employee status?'
        ...
        $('#confirmationButton').click(function(){
            ...
            $('#save-message').remove();
            setTimeout(function(){
                var serializedFormData = $('#employment_status_form').serialize();
                ...
                jsonObjExecuteService ["procedure_name_given"] = "postReqEmpStatus";  //given json element do not remove
