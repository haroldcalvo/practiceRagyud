$(document).ready(function(){
    $('#btnSave').click(function(){   
        var job_id = document.getElementById("job_reference").value.trim();
        ...
        $('#confirmationButton').click(function(){
            ...
            $('#save-message').remove();
            setTimeout(function(){
                var serializedFormData = $('#request_employee_jobs').serialize();
                ...
                jsonObjExecuteService ["procedure_name_given"] = "postReqEmpJob";  //given json element do not remove
